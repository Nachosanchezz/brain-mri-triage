...
preprocess_upenn.py
-------------------
Preprocesa UPENN-GBM a data/processed/upenn/*.npz con label=1.

UPENN se deja fuera de positives/negatives para que no entre por accidente en
los splits de entrenamiento. Es test externo.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Preprocesa UPENN-GBM a .npz para test externo.")
...
def main() -> None:
    ...
    if not args.input_dir.exists():
        ...
        print("Ejecuta primero: python src/preprocessing/convert_dicom_to_nifti_upenn.py")
        sys.exit(1)
