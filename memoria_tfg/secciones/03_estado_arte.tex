...
\subsection{Complejidad diagnóstica y necesidad de detección precoz}
...
La necesidad de detección precoz no debe entenderse aquí como cribado
poblacional, sino en el marco de estudios ya indicados clínicamente: el problema
...
puede tener un impacto relevante, y los sistemas de priorización (\emph{triage})
