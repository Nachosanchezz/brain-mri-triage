...
más cambio que el número de canales de entrada, a la cohorte intra-dominio. De
este modo, el uso de un pipeline común reduce las diferencias atribuibles al
procesamiento aplicado en este trabajo, aunque no elimina las diferencias previas
de adquisición, reconstrucción o preparación propias de cada cohorte.
...
entre el régimen confundido y el cross-dataset quede estrictamente controlada,
de modo que las diferencias observadas sean atribuibles solo al cambio de
partición y no a diferencias de método.
